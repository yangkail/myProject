...
// 	  System.out.println("gs_email"+gs_email);
 	  list = order_tableSvc.getAllGs_email(request.getParameter("gs_email"));
	}
	else {
// 		System.out.println("2");
//		System.out.println("rs_id"+(String)session.getAttribute("gs_email"));
		gs_email = (String)session.getAttribute("gs_email");
		list = order_tableSvc.getAllGs_email((String)session.getAttribute("gs_email"));
	}
