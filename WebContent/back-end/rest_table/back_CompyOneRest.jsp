...
<meta charset="UTF-8">
<title>餐廳細項</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/back-use/rest_table_use/back_CompyOneRest_use.css">
    	...
    	<hr>
   		...
   		<div class="div_content">
    		<div class="div_content1">
            	...
            	<form action="<%=request.getContextPath() %>/back-end/rest_table/back_deleteCompyOneRest.jsp" method="POST">
            		<div class="btns">
            			<button class="audit_btn">下架</button>
            			<input type="hidden" name="rs_id" value="${rest.rs_id }">
            			<input type="hidden" name="method" value="rest_review_application_sussess">
            			<button class="cancel_btn" type="button"><a href="<%=request.getContextPath()%>/back-end/rest_table/rest_backall.jsp">取消</a></button>
            		</div>
            	</form>
        	</div>
        </div>
