...
<meta charset="UTF-8">
<title>待審核餐廳</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/back-use/rest_table_use/back_verifyCompyRest_use.css">
    		...
    		<c:if test="${rest.authority==13}">
    			<div class="div_content">
    				<div class="div_content1">
            			...
            			<form action="<%=request.getContextPath() %>/back-end/rest_table/back_verifyOneCompyRest.jsp" method="POST">
