...
Rest_TableVO rest_TableVO=rest_TableService.getOneAll(request.getParameter("rs_id"));
...
<meta charset="UTF-8">
<title>審核餐廳</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/back-use/rest_table_use/back_verifyOneCompyRest_use.css">
...
<div style="margin-top:20px;margin-bottom:150px;text-align:center;">
	...
	<form action="<%=request.getContextPath() %>/rest_table/Rest_TableServlet_back" method="POST">
        ...
        <div class="div_submit">
            ...
            <input type="hidden" name="method" value="verify_and_select_rs">
    	...
    	<hr>
   		...
   		<div class="div_content">
    		<div class="div_content1">
            	...
            	<form action="<%=request.getContextPath() %>/back-end/rest_table/back_verifyOneCompyRest_confirm.jsp" method="POST">
            		<div class="btns">
            			<button class="audit_btn">審核</button>
