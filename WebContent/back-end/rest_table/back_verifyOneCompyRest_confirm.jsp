...
<meta charset="UTF-8">
<title>確認審核餐廳</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/back-use/rest_table_use/back_verifyOneCompyRest_confirm_use.css">
    	...
    	<hr>
   		...
   		<div class="div_content">
    		<div class="div_content1">
            	...
            	<form action="<%=request.getContextPath() %>/rest_table/Rest_TableServlet_back" method="POST">
            		<div class="btns">
            			<button class="audit_btn">確認審核</button>
