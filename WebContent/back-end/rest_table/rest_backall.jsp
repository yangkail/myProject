...
<body>
	<div class="header">
		...
		<a
			...
			<center><img src="<%=request.getContextPath()%>/images/logo.jpg"
			style="width: 25%; margin: auto;"></center>
		</a></div>
	...
	<div style="text-align: center;">
		<b><h3>
				<a
					href='<%=request.getContextPath()%>/back-end/rest_table/back_CompyRest.jsp'>已驗證餐廳查詢</a>
			</h3> </b>
	</div>
	...
	<div style="text-align: center;">
		<b><h3>
				<a
					href='<%=request.getContextPath()%>/back-end/rest_table/back_verifyCompyRest.jsp'>餐廳未審核查詢</a>
			</h3> </b>
	</div>
