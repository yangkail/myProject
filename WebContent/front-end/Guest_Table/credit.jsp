...
<link
	...
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/credit/credit.css"
	rel="stylesheet">
</head>
		...
		<c:when test="${gs_credit!=null }">
				...
				<div class="creditcard">
                    ...
                    <g id="Front">
                        ...
                        <text
								...
								class="st2 st3 st4">${gs_credit}</text>
                        <text
								transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname"
								class="st2 st5 st6">${gs_name}</text>
                        <text
			...
			<div class="form-container">
				<div class="field-container">
					<label for="name"><font size="5">姓名<font></label> <input
						id="name" maxlength="20" type="text" readonly="readonly"
						value="${gs_name}">
				</div>
				<div class="field-container">
					<label for="cardnumber"><font size="5">卡號</font></label><span
						id="generatecard">generate random</span> <input id="cardnumber"
						type="text" name="gs_credit" value="${gs_credit}"
						readonly="readonly">
				...
				<div class="field-container">
					<label for="expirationdate"><font size="5">到期日
							(mm/yy)</font></label> <input id="" type="text"
						readonly="readonly" value="**/**">
				</div>
				<div class="field-container">
					<label for="securitycode"><font size="5">安全碼</font></label> <input
						id="securitycode" type="text" readonly="readonly" value="***">

					<input type="hidden" name="action" value="updateCredit"> <input
						type="hidden" name="gs_email" value="${gs_email}"> <input
						type="button" class="nav-link login-button" value="修改信用卡"
						onclick="location.href='<%=request.getContextPath()%>/front-end/Guest_Table/addCredit.jsp'">
		...
		<c:when test="${gs_credit==null }">
			...
			<FORM METHOD="post"
				...
				<div class="form-container">
					<div class="field-container">
						<label for="name"><font size="5">姓名<font></label> <input
							id="name" maxlength="20" type="text" value="${gs_name }">
					</div>
					<div class="field-container">
						<label for="cardnumber"><font size="5">卡號</font></label><span
							id="generatecard">generate random</span> <input id="cardnumber"
							type="text" name="gs_credit" >
						<svg id="ccicon" class="ccicon" width="750" height="471"
							viewBox="0 0 750 471" version="1.1"
							xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink">
					...
					<div class="field-container">
						<label for="expirationdate"><font size="5">到期日
								(mm/yy)</font></label> <input id="expirationdate" type="text">
					</div>
					<div class="field-container">
						<label for="securitycode"><font size="5">安全碼</font></label> <input
							id="securitycode" type="text"> <input type="hidden"
							name="action" value="updateCredit"> <input type="hidden"
							name="gs_email" value="${gs_email}"> <input type="submit"
							class="nav-link login-button" value="新增信用卡">
			</FORM>
