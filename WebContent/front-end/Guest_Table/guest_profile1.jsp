...
<body class="body-wrapper" style="background-color:	#f8f9fa;">
		...
		<div class="row">
			...
			<div class="row">
					<div class="col-lg-6 col-md-6">
						...
						<div class="widget personal-info" style="width:950px; height='';">
							<h3 class="widget-header user"><font size="6"><center>會員基本資料</center></font></h3>
				
								<!-- Last Name -->
								
								<div class="form-group">
									<label for="gs_name">會員姓名</label>&nbsp&nbsp&nbsp&nbsp
										<td><font size="7">${gs_name}</font></td>
								</div>	
								
								<!-- Comunity Name -->
								<div class="form-group">
									<label for="comunity-name">電子信箱</label>&nbsp&nbsp&nbsp&nbsp
									<td><font size="6">${gs_email}</font></td>
								</div>
								<!-- Zip Code -->
								<div class="form-group">
									<label for="zip-code">生日</label>&nbsp&nbsp&nbsp&nbsp
									<td><font size="6">${gs_birth}</font></td>
								</div>
								<div class="form-group">
									<label for="zip-code">電話</label>&nbsp&nbsp&nbsp&nbsp
									<td><font size="6">${gs_phone}</font></td>
								</div>
							<div class="form-group">
								<label for="gs_reg_time">住址</label>&nbsp&nbsp&nbsp&nbsp
								<td><font size="6">${gs_address}</font></td>
							</div>
							
							<div class="form-group">
								<label for="gs_reg_time">註冊時間</label>&nbsp
								<td><font size="6">${gs_reg_time}</font></td>
							</div>
...
<script src="<%=request.getContextPath() %>/js/front_use/guest_table_use/pic_update.js"></script>
