...
Order_Rest_TableVO order_rest_tableVO = (Order_Rest_TableVO) request.getAttribute("Order_Rest_TableVO");
			...
			<div class="row">
					<div class="col-lg-6 col-md-6">
						...
						<div class="widget personal-info" style="width:1000px; height:800px;">
							<h3 class="widget-header user"><font size="6"><center>信用卡資訊</center></font></h3>
				
								<!-- Last Name -->
								<div>
								<iframe src="<%=request.getContextPath() %>/front-end/Feedback_Table/frontaddFeedback.jsp?order_id=${order_rest_tableVO.order_id}&rs_id=${order_rest_tableVO.rs_id}"  width="900" height="700"></iframe>
