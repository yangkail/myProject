				...
				<div class="sidebar">
					...
					<div class="widget dashboard-links">
						<ul>
							...
							<li><a class="my-1 d-inline-block" href="<%=request.getContextPath() %>/front-end/Guest_Table/credit.jsp">信用卡資訊 </a></li>
			...
			<div class="row">
					...
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Guest_Table/Guest_Table.do" name="form1">
						<div class="widget personal-info">
							<h3 class="widget-header user"><font size="6"><center>修改會員資料</center></font></h3>
				
								<!-- Last Name -->
								<div class="form-group">
									<label for="gs_name">會員姓名</label>&nbsp
										<td><font size="5"><input type="TEXT" name="gs_name" size="10" required="required"
			 							value="${gs_name}"/></font></td>
								</div>	
								
								<!-- Comunity Name -->
								<div class="form-group">
									<label for="comunity-name">電子信箱</label>&nbsp
									<td><font size="5">${gs_email}</font></td>
								</div>
								<!-- Zip Code -->
								<div class="form-group">
									<label for="zip-code">生日</label>&nbsp
									<td><input name="gs_birth" value="${gs_birth}" id="f_date1" size="10" type="text" required="required"/></td>
								</div>
								<div class="form-group">
									<label for="zip-code">電話</label>&nbsp
									<td><font size="5"><input type="TEXT" name="gs_phone" size="10"
			 							value="${gs_phone}" pattern="^[(0-9_)]{10}$"/></font></td>
								</div>
							<div class="form-group">
								<label for="gs_reg_time">住址</label>&nbsp
								<td><font size="3"><input type="TEXT" name="gs_address" size="23"
			 							value="${gs_address}" required="required"/></font></td>
							</div>
							
							<div class="form-group">
							
								<td><input name="gs_reg_time" value="${gs_reg_time}" id="f_date1" size="10" type="hidden" /></td>
							</div>
							
							
							<input type="hidden" name="gs_pwd" size="10"
								value="${gs_pwd}"/>
								
								<input type="hidden" name="gs_sex" size="25"
								value="${gs_sex}"/>
								
								<input type="hidden" name="gs_credit" size="25"
								value="${gs_credit}"/>
						...
						<input type="submit" class="nav-link login-button" value="送出修改">
