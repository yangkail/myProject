...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
      <span id="amount">paying: <strong>${ad_price}</strong></span>
      <span id="card-image">
...
<%-- <FORM METHOD="post" ACTION="<%=request.getContextPath() %>/controller/Ad_TableDAOServletFront_End" name="form1" enctype="multipart/form-data"> --%>
  ...
  <label>
  <a href='<%=request.getContextPath()%>/front-end/ad_table/Ad_PaySucces.jsp'><button type="button"id="card-btn" name="action" value="insert1" style="font-size:20px; font-weight:bold;">確認</button></a>
