...
<title>餐廳訂位資料新增 - addBK_ing.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>餐廳訂位資料新增 - addBK_ing.jsp</h3></td><td>
	...
	<tr>
		...
		<td><select size="1" name="rs_sieral">
			<c:forEach var="booking_Fixed_TableVO" items="${booking_Fixed_TableSvc.all}">
				<option value="${booking_Fixed_TableVO.rs_sieral}"${(booking_Ing_TableVO.rs_sieral==booking_Fixed_TableVO.rs_sieral)? 'selected':'' } >${booking_Fixed_TableVO.rs_sieral}-桌號${booking_Fixed_TableVO.rs_table_number}
			</c:forEach>
		</select></td>
	</tr>
