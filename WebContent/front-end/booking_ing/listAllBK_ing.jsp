...
<%
	...
	List<Booking_Ing_TableVO> list = booking_Ing_TableSvc.getAll();
			...
			<td>
				...
				<h4>
					<a
						...
						<img src="<%=request.getContextPath()%>/front_end/booking_ing/images/back1.gif" width="100" height="32" border="0">回首頁
					</a>
				</h4>
			</td>
		</tr>
