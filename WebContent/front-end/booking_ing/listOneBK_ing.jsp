...
<%
	...
	Booking_Fixed_TableVO booking_Fixed_TableVO = booking_Fixed_TableSvc
			.getOneBooking_Fixed_Table(booking_Ing_TableVO.getRs_sieral());
%>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a
						href="<%=request.getContextPath()%>/front_end/booking_ing/select_pageBK_ing.jsp"><img
						src="../front_end/booking_fixed/images/back1.gif" width="100"
						height="33" border="0">回首頁</a>
				</h4>
			</td>
		</tr>
	</table>
	...
	<table>
		...
		<tr>
			...
			<td>${(booking_Ing_TableVO.rs_status=='0')? '未訂位':'已訂位'}(<%=booking_Ing_TableVO.getRs_status()%>)
			</td>
			...
			<td>${booking_Ing_TableVO.gs_select_time}</td>
			<td>
				<FORM METHOD="post"
					ACTION="<%=request.getContextPath()%>/booking_ing_table/booking_Ing_TableServlet.do"
					style="margin-bottom: 0px;">
					<input type="submit" value="修改"> <input type="hidden"
						name="order_id" value="${booking_Ing_TableVO.order_id}"> <input
