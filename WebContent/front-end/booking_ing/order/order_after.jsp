...
<body>
	...
	<div id="thanks">
		...
		<h1 id="h1_">感謝你</h1>
		<p id="p_">
			您所預定餐廳不需付訂金<br> 請至於會員管理確認訂單<br> 如欲取消請於訂位時間前一小時至會員管理取消訂位
		</p>
		<span id="sp" style="color: red;">5秒後回至首頁</span>
	...
	x--;
	if(x>0){
	document.getElementById("sp").innerHTML=x+"秒後回至首頁"; //每次設置的x的值都不一樣了。
	}else{
	location.href='<%=request.getContextPath()%>/front-end/Guest_Table/home.jsp';
	}
	}
	</script>
