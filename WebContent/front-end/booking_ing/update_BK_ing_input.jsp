...
<title>訂單狀態資料修改 - update_BK_ing_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>訂單狀態資料修改 - update_BK_ing_input.jsp</h3>
				<h4>
					<a
	...
	<FORM METHOD="post"
		...
		<table>
			<tr>
				<td>餐廳公版流水編號:<font color=red><b>*</b></font></td>
				<td><%=booking_Ing_TableVO.getOrder_id()%></td>
			</tr>
			<tr>
				<td>餐廳座位狀態:</td>
				<td><input type="TEXT" name=rs_status size="45"
					value="<%=booking_Ing_TableVO.getRs_status()%>" /></td>
			</tr>
			...
			<tr>
				...
				<td>選擇消費者訂位的時段:</td>
				<td><select size="1" name="gs_select_time">
						
							<option value="1">上午8點-下午1點</option>
							<option value="2">下午1點-晚上6點</option>
							<option value="3">晚上6點-晚上11點</option>
			...
			<tr>
				...
				<td><select size="1" name="rs_sieral">
						<c:forEach var="booking_Fixed_TableVO"
							...
							<option value="${booking_Fixed_TableVO.rs_sieral}"
								${(booking_Ing_TableVO.rs_sieral==booking_Fixed_TableVO.rs_sieral)? 'selected':'' }>${booking_Fixed_TableVO.rs_sieral}-桌號${booking_Fixed_TableVO.rs_table_number}
						</c:forEach>
				</select></td>
			</tr>
		...
		<br> <input type="hidden" name="action" value="update"> <input
			...
			value="<%=booking_Ing_TableVO.getOrder_id()%>"> <input
