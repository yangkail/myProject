...
public class Booking_Fixed_TableServlet extends HttpServlet {
	...
	public void getOne_For_Display(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/booking_fixed/select_page.jsp");
			...
			String url = "/front-end/booking_fixed/listOneEmp.jsp";
	...
	public void insert(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (!errorMsgs.isEmpty()) {
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/booking_fixed/addEmp.jsp");
				failureView.forward(req, res);
				return;
			}
			...
			String url = "/front-end/booking_fixed/listAllEmp.jsp";
	...
	public void getOne_For_Update(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			/*************************** 3.查詢完成,準備轉交(Send the Success view) ************/
			req.setAttribute("booking_Fixed_TableVO", booking_Fixed_TableVO); // 資料庫取出的empVO物件,存入req
			String url = "/front-end/booking_fixed/update_emp_input.jsp";
			...
			RequestDispatcher failureView = req.getRequestDispatcher("/front-end/booking_fixed/listAllEmp.jsp");
			failureView.forward(req, res);
		}
	}
		...
		try {
			...
			if (!errorMsgs.isEmpty()) {
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/booking_fixed/update_emp_input.jsp");
				failureView.forward(req, res);
				return;
			}
			...
			RequestDispatcher failureView = req.getRequestDispatcher("/front-end/booking_fixed/update_emp_input.jsp");
			failureView.forward(req, res);
		}
