...
public class Booking_Fixed_Table_List_Ajax extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			List<Booking_Fixed_TableVO> booking_Fixed_TableList = booking_Fixed_TableSvc.select_get_rs_id_all(rs_id);
			
		
			if (booking_Fixed_TableList == null) {
				errorMsgs.add("查無資料");
			}
			...
			String jsonStr = new JSONArray(booking_Fixed_TableList).toString();
