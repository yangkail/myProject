...
public class Booking_Fixed_TableService {
	...
	public Booking_Fixed_TableVO addbooking_fixed_table(String rs_table_number, Integer rs_table_seat,
			String rs_seat_sieral) {
	...
	public Booking_Fixed_TableVO updatebooking_fixed_table(String rs_sieral, String rs_table_number,
			Integer rs_table_seat, String rs_seat_sieral) {
	...
	public Booking_Fixed_TableVO findByRS_SEAT_SIERAL(String rs_seat_sieral) {
		...
		return dao.findByRS_SEAT_SIERAL(rs_seat_sieral);
	};

	public Booking_Fixed_TableVO insertwithorder(String rs_table_number, Integer rs_table_seat,
			String rs_seat_sieral, List<Booking_Ing_TableVO> booking_Ing_TableList) {
		...
		dao.insertwithorder(booking_Fixed_TableVO1, booking_Ing_TableList);
