...
public class Order_TableVO implements java.io.Serializable {
	
	@Override
	public String toString() {
		return "Order_TableVO [order_id=" + order_id + ", rs_id=" + rs_id + ", gs_email=" + gs_email + ", order_status="
				+ order_status + ", order_time=" + order_time + ", order_cancel_time=" + order_cancel_time
				+ ", gs_order_remark=" + gs_order_remark + ", gs_people=" + gs_people + ", gs_select_time="
				+ gs_select_time + ", order_deposit=" + order_deposit + ", order_qrcode="
				+ Arrays.toString(order_qrcode) + ", rs_table_status=" + rs_table_status + "]";
	}
