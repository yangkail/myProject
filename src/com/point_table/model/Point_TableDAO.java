...
public class Point_TableDAO implements Point_TableDAO_interface {
	...
	public void insert(Point_TableVO point_tableVO) {
		...
		try {
			...
			pstmt.setString(2, point_tableVO.getOrder_id());
			pstmt.setString(3, point_tableVO.getGs_email());
			pstmt.setInt(4, point_tableVO.getOrder_get_point());
			pstmt.setInt(5, point_tableVO.getOrder_use_point());
			pstmt.setTimestamp(6, point_tableVO.getPoint_update_time());
