...
@WebServlet(urlPatterns = { "/Rest_Seat_Coordinate_Table_Getlist_Ajax.do" })
public class Rest_Seat_Coordinate_Table_Getlist_Ajax extends HttpServlet {
	@Override
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		PrintWriter out = res.getWriter();HttpSession session = req.getSession();
...
//			String gs_select_time = req.getParameter("gs_select_time");
			//先取得進來的使用者 RS_ID的資料
			String rs_id1 = (String) session.getAttribute("rs_id");
			// 請求進來由字串處理
			...
			List<Rest_Seat_Coordinate_TableVO> rest_Seat_Coordinate_TableVO 
			= rest_Seat_Coordinate_TableSvc.get_RS_ID_All(rs_id);
...
//			jsonObject.put("rs_id",rs_id);
			// List to JSON
			//再包裝成JSON傳給前端
			String jsonStr = new JSONArray(rest_Seat_Coordinate_TableVO).toString();
